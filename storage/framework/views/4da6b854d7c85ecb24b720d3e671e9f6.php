<?php $__env->startSection('title', 'Login To Digivardan'); ?>
    ...
    <style>
        ...
        .auth-container {
            ...
            background: linear-gradient(rgba(42, 92, 130, 0.9),
                    rgba(91, 164, 230, 0.9)),
                url('<?php echo e(asset('images/hero/Reg.jpg')); ?>');
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="text-center">
                                <p class="mb-0">New to DigiVardan?
                                    <a href="<?php echo e(route('register')); ?>" class="text-accent">Create Account</a>
                                </p>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Project\Doc\FYP\Telimedical platform\Digivardan\Digivardan\resources\views/auth/login.blade.php ENDPATH**/ ?>