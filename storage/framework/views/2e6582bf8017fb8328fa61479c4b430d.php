    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(rgba(42, 92, 130, 0.9), rgba(91, 164, 230, 0.9)),
                url('<?php echo e(asset('images/hero/medical-team.png')); ?>');
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-lg-2">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-accent">Register</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 text-center text-lg-start">
                    ...
                    <div class="d-flex gap-3 justify-content-center justify-content-lg-start">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-light btn-lg px-5 cta-pulse">
                    ...
                    <div class="testimonial-sidebar">
                        ...
                        <div class="doctor-card mb-4 p-3">
                            <div class="d-flex align-items-center">
                                <img src="<?php echo e(asset('images/testimonials/testimonies.png')); ?>"
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="<?php echo e(asset('images/logos/team.jpg')); ?>" alt="Our Medical Team"
...
<?php /**PATH H:\Project\Doc\FYP\Telimedical platform\Digivardan\Digivardan\resources\views/welcome.blade.php ENDPATH**/ ?>