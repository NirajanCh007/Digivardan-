<?php $__env->startSection('title', 'Register To Digivardan'); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('register')); ?>">
                            ...
                            <div class="text-center mt-3">
                                <p class="mb-0">Already have an account?
                                    <a href="<?php echo e(route('login')); ?>" class="text-accent">Login here</a>
                                </p>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH H:\Project\Doc\FYP\Telimedical platform\Digivardan\Digivardan\resources\views/auth/register.blade.php ENDPATH**/ ?>