    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
                ...
                <div class="card-body">
                    <div class="row g-4 align-items-center">
                        <div class="col-md-4 text-center">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($patient->name) }}&background=0D8ABC&color=fff&size=128"
                                alt="Profile" class="rounded-circle border shadow" width="120">
                        </div>

                        <div class="col-md-8">
                            <h5 class="fw-bold text-dark mb-2">{{ $patient->name }}</h5>
                            <p class="mb-1"><strong>Email:</strong> {{ $patient->email }}</p>
                            <p class="mb-1"><strong>Role:</strong> {{ ucfirst($patient->role) }}</p>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                ...
                @empty
                    <div class="col">
                        <div class="alert alert-info w-100 px-30">
                            No appointmets done
                        </div>
                    </div>
                @endforelse
